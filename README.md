...
If you publish a hosted preview, add it here so reviewers can try the app without installing anything.

- Frontend URL: `<add-your-hosted-frontend-url>`
- Backend/API URL: `<add-your-hosted-backend-url>`
